                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                            ...
                                            <td class="delete-item">
                                                <a @click="removeItem(keranjangUser.index)" href="#"><i class="material-icons">close</i></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="user-checkout text-left">
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               class="form-control" 
                                               id="namaLengkap" aria-describedby="namaHelp" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               class="form-control" 
                                               id="noHP" aria-describedby="noHPHelp" 
...
export default {
    ...
    computed:{
        ...
        totalBiaya(){
            return this.subTotal + this.ditambahPajak ;
        }
    }
};
</script>